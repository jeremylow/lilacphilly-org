...
class FilterTests(TestCase):
    ...
    def test_generate_page_title(self):
        ...
        with open("common/test_data/bulletins.bulletinemail.json") as f:
            ...
            assert (
                title
                == "Test Site - Show up to Resist Trump, Resist Corporate Greed, and Support Workers!"
            ), title
    ...
    def test_generate_page_description(self):
        ...
        with open("common/test_data/bulletins.bulletinemail.json") as f:
            ...
            assert (
                desc
                == "SEIU 32BJ Philadelphia Airport workers need your support on July 13. PHL Airport workers-who are mostly low-wage immigrants and people ..."
            ), desc
    ...
    def test_organziation_jsonld(self):
        ...
        assert org_json["sameAs"] == [
            "https://www.facebook.com/example",
            "https://www.twitter.com/example",
            "https://instagram.com/example",
            "https://youtube.com/example",
        ]
        assert org_json["address"]["addressStreet"] == "123 Main Street", org_json[
            "address"
        ]
